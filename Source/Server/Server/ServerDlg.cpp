...
void CServerDlg::OnEnChangeEdit2()		// SERVER SHOW MESSAGE BOX
{
...
void CServerDlg::OnBnClickedButton1()	// START
{
	// TODO: Add your control notification handler code here
...
void CServerDlg::OnBnClickedButton2()	// STOP
{
	// TODO: Add your control notification handler code here
...
void CServerDlg::OnEnChangeEdit1()		// PORT
{
	// TODO:  If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialogEx::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CServerDlg::OnBnClickedButton3()		// Xstop
{
	// TODO: Add your control notification handler code here
	CloseHandle(m_Thread_handle);
	m_pServer->CloseConnect();
